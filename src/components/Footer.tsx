    ...
    return (
        <FooterBlock>
            <BusinessSection>
                ...
                <Text>
                    주소 : 서울특별시 서초구 서초대로77길 17, 스파크플러스
                    강남4호점 13층, 1306호
                </Text>
                <Text>
                    고객센터 :
                    support@playpet.me&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;010-9235-0736
                </Text>
            </BusinessSection>
            <ProvisionSection>
                <Link
                    target="_blank"
                    href="https://docs.google.com/document/d/1kWXTsC_KWR3SNG1T8eCVXTN8O9XY2bz_yeZVmMO5kd4/edit?usp=sharing"
                >
                    이용약관
                </Link>
                <Link
                    target="_blank"
                    href="https://docs.google.com/document/d/1y9a-1p2gRYxVgXUX2VWyRM_BKRnMcrVGqxbu1JTT0Mw/edit?usp=sharing"
                >
                    개인정보 처리방침
                </Link>
                <SocialBlock>
                    <a
                        target="_blank"
                        rel="noreferrer"
                        href="https://www.facebook.com/playpet.me/"
                    >
                    ...
                    <a
                        target="_blank"
                        rel="noreferrer"
                        href="https://www.instagram.com/playpet.me"
                    >
